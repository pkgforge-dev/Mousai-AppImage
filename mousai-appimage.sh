...
export OUTNAME=Mousai-"$VERSION"-anylinux-"$ARCH".AppImage
...
./quick-sharun /usr/bin/mousai /usr/lib/gio/modules/libgiognomeproxy.so /usr/lib/gio/modules/libgiognutls.so /usr/lib/gio/modules/libgiolibproxy.so
